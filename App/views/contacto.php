...
<body>
    ...
    <main>
        ...
        <section>
            ...
            <a href="<?= $contactEmail ?>" class="moduloBoton02">
                <span>Enviar correo de consulta</span>
                <img src="<?=$_ENV['RUTA']?>/assets/img/system/arrow-forward-outline.svg" alt="Enviar correo" title="Correo de contacto">
            </a>
        </section>
        ...
        <section>
            ...
            <article class="art01">
                ...
                <div>
                    ...
                    <a href="<?= $contactUrl ?>" class="moduloBoton02">
                        <span>Solicitar presupuesto de pintura</span>
                        <img src="<?=$_ENV['RUTA']?>/assets/img/system/arrow-forward-outline.svg" alt="Ir al formulario" title="Formulario de contacto">
                    </a>
                </div>
            </article>
            ...
            <article class="art01 upsidedown">
                ...
                <div>
                    ...
                    <a href="<?= $contactUrl ?>" class="moduloBoton02">
                        <span>Solicitar presupuesto de restauración</span>
                        <img src="<?=$_ENV['RUTA']?>/assets/img/system/arrow-forward-outline.svg" alt="Ir al formulario" title="Formulario de contacto">
                    </a>
                </div>
            </article>
        ...
        <section>
            ...
            <p>Rellena el formulario con los datos básicos de tu proyecto y te responderé con una propuesta orientativa. Si prefieres, también puedes llamarme para una atención más directa.</p>
        </section>
